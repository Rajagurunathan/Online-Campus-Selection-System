...
namespace Orange_Project
{
    public partial class Student_Signup : System.Web.UI.Page
    {
        ...
        {
            SqlConnection con = new SqlConnection(@"Data Source=sql.freeasphost.net\MSSQL2016;Initial Catalog=orange_SampleDB;User ID=orange_SampleDB;Password=DBSamplePW");
            con.Open();
